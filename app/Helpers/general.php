...
if ( ! function_exists('status')){
	...
	{
		return "<span class='badge badge-$badge bg-$badge'>$label</span>";
	}
}
...
if ( ! function_exists('profile_picture')){
	function profile_picture( $profile_picture = '' ) 
	{
		...
		return $profile_picture != '' ? asset('public/uploads/profile/'.$profile_picture) : asset('public/images/avatar.png'); 
	}
}
...
if ( ! function_exists('currency')){
	function currency($symbol = false) 
	{
	    ...
	    return $symbol == false ? $currency_code : get_currency_symbol( $currency_code );
	}
}
