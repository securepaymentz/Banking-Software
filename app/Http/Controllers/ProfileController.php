...
class ProfileController extends Controller
{
    ...
    public function edit()
    {
		...
		return view('backend.user_panel.profile.profile_edit',compact('profile'));		
    }
    ...
    public function change_password()
    {
		...
		return view('backend.user_panel.profile.change_password');
    }
    ...
    public function referral_link()
    {
		...
		return view('backend.user_panel.profile.referral_link');
    }
