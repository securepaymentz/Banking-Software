<form method="post" class="ajax-submit" autocomplete="off" action="{{action('WithdrawController@update', $id)}}" enctype="multipart/form-data">
	...
	<div class="col-md-12">
		<div class="form-group">
			...
			@php $account = $withdraw->account->account_number.' ('.get_account_balance($withdraw->account_id, $withdraw->user_id) .')' @endphp					
       ...
       $.ajax({
          ...
          beforeSend: function(){
              ...
              jQuery.each( json, function( i, val ) {
				 $("#account_id").append("<option value='" + val.id + "'>" + val.account_number + ' (' +  val.balance + ")</option>");
			  });
          }
       });
   }
