				 ...
				 <table class="table table-bordered data-table">
					...
					<tbody>
					  ...
					  <tr id="row_{{ $account->id }}">
						...
						<td class='opening_balance text-right'>{{ decimalPlace($account->opening_balance, $currency) }}</td>				
						<td class='current_balance text-right'>{{ decimalPlace($account->balance, $currency) }}</td>					
