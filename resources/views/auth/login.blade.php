	...
	<div class="container">
		...
		<div class="single-col-max mx-auto over-curve px-5">  
			...
			<div class="auth-wrapper mx-auto">
				<h2 class="auth-heading text-center mb-4">{{ _lang('Sign in to your account') }}</h2>
				...
				<div class="auth-form-container text-left mx-auto"> 
					<form method="POST" class="auth-form signup-form validate" action="{{ route('login') }}">
						...
						<div class="form-group email">
							...
							<input id="signin-email" name="email" type="email" value="{{ old('email') }}" class="form-control signin-email{{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="{{ _lang('Email') }}" required="required">
						...
						<div class="form-group password">
							...
							<input id="signin-password" name="password" type="password" class="form-control signin-password{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ _lang('Password') }}" required="required">
						...
						<div class="text-center">
							<button type="submit" class="btn btn-primary btn-gradient btn-submit theme-btn mx-auto">{{ _lang('Sign in') }}</button>
						</div>
					</form>
				...
				<div class="social-auth text-center mx-auto mt-2">                        
					<ul class="social-buttons list-unstyled">
						...
						@endif
						<!--<li class="mb-3"><a href="#" class="btn btn-social btn-block"><span class="icon-holder"><span class="icon-holder"><img src="assets/images/social/twitter-logo.svg" alt=""></span></span><span class="btn-text">Sign in with Twitter</span></a></li>
						<li class="mb-3"><a href="#" class="btn btn-social btn-block"><span class="icon-holder"><span class="icon-holder"><img src="assets/images/social/github-logo.svg" alt=""></span></span><span class="btn-text">Sign in with Github</span></a></li>-->
					</ul>
				</div><!--//social-auth-->
